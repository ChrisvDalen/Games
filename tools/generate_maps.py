...
def build_colony():
    ...
    objects = [
        ...
        obj(9, "salvage_a", "resource_node", 5, 8, h,
            [prop("item", "scrap_alloy"), prop("sprite", "node_scrap"), prop("min", 2), prop("max", 3), prop("respawnDays", 3)]),
        obj(10, "salvage_b", "resource_node", 8, 9, h,
            [prop("item", "scrap_alloy"), prop("sprite", "node_scrap"), prop("min", 1), prop("max", 3), prop("respawnDays", 3)]),
        obj(11, "salvage_c", "resource_node", 20, 14, h,
            [prop("item", "scrap_alloy"), prop("sprite", "node_scrap"), prop("min", 2), prop("max", 4), prop("respawnDays", 3)]),
        obj(12, "salvage_d", "resource_node", 20, 6, h,
            [prop("item", "salvaged_cell"), prop("sprite", "node_scrap"), prop("min", 1), prop("max", 2), prop("respawnDays", 4)]),
        obj(13, "salvage_e", "resource_node", 6, 6, h,
            [prop("item", "salvaged_cell"), prop("sprite", "node_scrap"), prop("min", 1), prop("max", 1), prop("respawnDays", 5)]),
...
def build_terrace():
    ...
    objects = [
        ...
        obj(7, "stalks_a", "resource_node", 20, 12, h,
            [prop("item", "resin_fibre"), prop("sprite", "node_stalk"), prop("min", 2), prop("max", 3), prop("respawnDays", 2)]),
        obj(8, "stalks_b", "resource_node", 22, 14, h,
            [prop("item", "resin_fibre"), prop("sprite", "node_stalk"), prop("min", 1), prop("max", 3), prop("respawnDays", 2)]),
        obj(9, "stalks_c", "resource_node", 19, 3, h,
            [prop("item", "resin_fibre"), prop("sprite", "node_stalk"), prop("min", 2), prop("max", 2), prop("respawnDays", 2)]),
        obj(10, "glass_a", "resource_node", 23, 8, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 1), prop("max", 2), prop("respawnDays", 3)]),
        obj(11, "glass_b", "resource_node", 23, 5, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 2), prop("max", 3), prop("respawnDays", 3)]),
...
def build_biome():
    ...
    objects = [
        ...
        obj(7, "shard_a", "resource_node", 7, 7, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 2), prop("max", 4), prop("respawnDays", 3)]),
        obj(8, "shard_b", "resource_node", 9, 14, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 1), prop("max", 3), prop("respawnDays", 3)]),
        obj(9, "shard_c", "resource_node", 20, 12, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 2), prop("max", 3), prop("respawnDays", 3)]),
        obj(10, "shard_d", "resource_node", 24, 5, h,
            [prop("item", "silica_shard"), prop("sprite", "node_mineral"), prop("min", 1), prop("max", 4), prop("respawnDays", 3)]),
        obj(11, "lumen_a", "resource_node", 11, 6, h,
            [prop("item", "lumen_shard"), prop("sprite", "node_mineral"), prop("min", 1), prop("max", 2), prop("respawnDays", 4),
             prop("tool", "cutter")]),
        ...
        obj(14, "fibre_b", "resource_node", 24, 16, h,
            [prop("item", "resin_fibre"), prop("sprite", "node_stalk"), prop("min", 2), prop("max", 4), prop("respawnDays", 2)]),
